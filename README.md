...
## This is a test-only example for teaching use. Please do not use unless you are students enrolled in COMP SCI 7317_7617 UMLT2025

The implementation borrows ideas from ICLR 2025 paper:
...
## 2. Testing R-Detect with vectorised text file

```bash
python ./main.py \
    --test_file ./demo_text_gpt.txt \ # The file path of the test file. Default is demo_text.csv
    --use_gpu \ # Use GPU or not.
