...
def get_metadata(args, fea_dic):
    ...
    for i in range(meta_bs):  # one batch means one set
        ...
        for cur_source_real, cur_source_generated in zip(
            selected_source_real, selected_source_generated
        ):
            selected_real = np.random.choice(
                get_data_num(cur_source_real), (k_shot + k_query), False
            )
            selected_generated = np.random.choice(
                get_data_num(cur_source_generated), (k_shot + k_query), False
            )
            ...
            y_spt.append(
                fea_dic[cur_source_generated]["generated"][selected_generated[:k_shot]]
            )
            y_qry.append(
                fea_dic[cur_source_generated]["generated"][selected_generated[k_shot:]]
            )
